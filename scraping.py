...
#Create a function to intialize browser, create data dictionary, end the WebDriver, and return scraped data
def scrape_all():
...
#Create a function to update/scrape Mars News
...
#Create a function to update featured image
